...
const pageStyle = {
  backgroundImage: "url('ruta/a/tu/imagen/fondo.jpg')", // Cambia la ruta a la imagen de fondo
      ...
      <div style={pageStyle}>
        <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
          <div style={{ width: 'calc(100%/3)' }}>
            <Titulo entidad="Registro de Alumnos"  />
            <InstrumentoList instrumentos={this.state.instrumentos} />
            <br />
            <Link to="/nuevo-instrumento">Nuevo Registro</Link>
			<br />
			
			
          </div>
          <div style={{ width: 'calc(100%/3)' }}>
            <Titulo entidad="Curso" />
            <MusicoList musicos={this.state.musicos} />
            <br />
            <Link to="/nuevo-musico">Nuevo Curso</Link>
          </div>
          <div style={{ width: 'calc(100%/3)' }}>
            <Titulo entidad="Profesores"  />
            <BandaList bandas={this.state.bandas} />
            <br />
            <Link to="/nueva-banda">Nuevo Profesor</Link>
			<br />
	...
	render() {
		...
		return (
			<tr>
				...
				<td>
				    <Link to={`/editar-instrumento/${1}`}>Editar</Link>
	...
	render() {
		...
		return (
			<tr>
				...
				<td>
				<Link to={`/editar-musico/${1}`}>Editar</Link>
	...
	render() {
	  ...
	  return (
		<tr>
		  ...
		  <td>
		  <Link to={`/editar-banda/${1}`}>Editar</Link>
